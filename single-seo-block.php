...
<?php get_template_part( 'template-parts/header/develop-header' ); ?>
    <main class="main main-single block-seo">
      <div class="container">
        <div class="main__text-wrapper">
          <h1>Продвижение сайта</h1>
          <h3>
            Продвижение вашего сайта путём настройки рекламной кампании и
            оптимизации текста. Точный срок и расчет стоимости устанавливается
            после изучения Вашего проекта. Уточнить детали: 8(904)341-70-02
          </h3>
    ...
    <section class="seo">
      <div class="container">
        <h2 class="seo__title sec-title">
          CodeLead осуществляет полную оптимизацию сайта для роста Вашего
          бизнеса
        </h2>
        <div class="seo__wrapper wrapper-grid">
          <div class="seo__item big">
            <i class="fas fa-rocket"></i>
            <h3 class="seo__item-title">SEO оптимизация</h3>
            <p class="seo__item-text">
              SEO-продвижение – сложный, но действенный метод
              интернет-маркетинга, который позволяет развить ваш сайт и бизнес в
              целом. В ходе него проводятся работы с семантическим ядром,
              контентом, со структурой и содержанием страниц сайта. Производится
              оптимизация ресурса, работа над юзабилити и многое другое. Все это
              повышает доверие поисковых систем к вашему сайту и помогает ему
              встать в ТОП выдачи.
            </p>
          </div>
          <div class="seo__item">
            <i class="fas fa-thumbs-up"></i>
            <h3 class="seo__item-title">SMM и SMO</h3>
            <p class="seo__item-text">
              Продвижение в социальных сетях позволяет достичь Ваших
              бизнес-целей, которые сложно решить с помощью стандартных
              рекламных кампаний. Правильная SMM-стратегия позволяет выстроить
              новый эффективный канал для роста продаж.
            </p>
          </div>
          <div class="seo__item">
            <i class="fas fa-chart-line"></i>
            <h3 class="seo__item-title">Торговые площадки</h3>
            <p class="seo__item-text">
              Сегодня многие компании считают единственно верным решением выйти
              на маркетплейс самостоятельно, путем создания собственных
              ресурсов, инвестируя в этот процесс достаточно большое количество
              средств и времени.
            </p>
          </div>
          <div class="seo__item big">
            <i class="fab fa-readme"></i>
            <h3 class="seo__item-title">Контекстная реклама</h3>
            <p class="seo__item-text">
              Несомненные плюсы контекстной рекламы в сравнении с поисковым
              продвижением — высокая скорость запуска рекламной кампании и
              оперативность получения результатов. Это делает контекстную
              рекламу идеальным инструментом для быстрого старта нового
              направления бизнеса, для рекламы новинок ассортимента и для
              анонсирования специальных акций.
            </p>
          </div>
        </div>
      </div>
