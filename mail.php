...
if(!$mail->send()) {
    echo 'Отправка временно не работает, извиняемся за технические неполадки. В скором времени, всё будет в порядке!<br>Перейдите на главную страницу: https://codelead.ru/ и попробуйте связаться через telegram или whats app';
} else {
